...
(function renderAddresses(displayNum) {
  document.querySelector('.carousel-container').addEventListener('click', handleClick);

  getAddresses()
    .then(response => response.body.map((address, idx) => {
